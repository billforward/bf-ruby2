...
# Unit tests for Bfwd::UpdateComponentValueAmendment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateComponentValueAmendment' do
  before do
    # run before each test
    @instance = Bfwd::UpdateComponentValueAmendment.new
  end
  ...
  describe 'test an instance of UpdateComponentValueAmendment' do
    it 'should create an instance of UpdateComponentValueAmendment' do
      expect(@instance).to be_instance_of(Bfwd::UpdateComponentValueAmendment)
    end
  end
