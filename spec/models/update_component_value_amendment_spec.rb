...
# Unit tests for BillForward::UpdateComponentValueAmendment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateComponentValueAmendment' do
  before do
    # run before each test
    @instance = BillForward::UpdateComponentValueAmendment.new
  end
  ...
  describe 'test an instance of UpdateComponentValueAmendment' do
    it 'should create an instact of UpdateComponentValueAmendment' do
      expect(@instance).to be_instance_of(BillForward::UpdateComponentValueAmendment)
    end
  end
  ...
  describe 'test attribute "pricing_component_value_id"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "pricing_component_value_change_id"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
