...
# Unit tests for BillForward::CreateSubscriptionChargeAmendment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateSubscriptionChargeAmendment' do
  before do
    # run before each test
    @instance = BillForward::CreateSubscriptionChargeAmendment.new
  end
  ...
  describe 'test an instance of CreateSubscriptionChargeAmendment' do
    it 'should create an instact of CreateSubscriptionChargeAmendment' do
      expect(@instance).to be_instance_of(BillForward::CreateSubscriptionChargeAmendment)
    end
  end
  ...
  describe 'test attribute "subscription_charge"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "pricing_component_value_change"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
