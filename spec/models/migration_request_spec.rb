...
# Unit tests for BillForward::MigrationRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MigrationRequest' do
  before do
    # run before each test
    @instance = BillForward::MigrationRequest.new
  end
  ...
  describe 'test an instance of MigrationRequest' do
    it 'should create an instact of MigrationRequest' do
      expect(@instance).to be_instance_of(BillForward::MigrationRequest)
    end
  end
