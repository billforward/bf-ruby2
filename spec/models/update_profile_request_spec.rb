...
# Unit tests for BillForward::UpdateProfileRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateProfileRequest' do
  before do
    # run before each test
    @instance = BillForward::UpdateProfileRequest.new
  end
  ...
  describe 'test an instance of UpdateProfileRequest' do
    it 'should create an instact of UpdateProfileRequest' do
      expect(@instance).to be_instance_of(BillForward::UpdateProfileRequest)
    end
  end
