...
# Unit tests for BillForward::DunningLine
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DunningLine' do
  before do
    # run before each test
    @instance = BillForward::DunningLine.new
  end
  ...
  describe 'test an instance of DunningLine' do
    it 'should create an instact of DunningLine' do
      expect(@instance).to be_instance_of(BillForward::DunningLine)
    end
  end
