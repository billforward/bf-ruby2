...
# Unit tests for Bfwd::EmailProvider
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EmailProvider' do
  before do
    # run before each test
    @instance = Bfwd::EmailProvider.new
  end
  ...
  describe 'test an instance of EmailProvider' do
    it 'should create an instance of EmailProvider' do
      expect(@instance).to be_instance_of(Bfwd::EmailProvider)
    end
  end
