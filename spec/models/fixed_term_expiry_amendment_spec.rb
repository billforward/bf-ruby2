...
# Unit tests for BillForward::FixedTermExpiryAmendment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FixedTermExpiryAmendment' do
  before do
    # run before each test
    @instance = BillForward::FixedTermExpiryAmendment.new
  end
  ...
  describe 'test an instance of FixedTermExpiryAmendment' do
    it 'should create an instact of FixedTermExpiryAmendment' do
      expect(@instance).to be_instance_of(BillForward::FixedTermExpiryAmendment)
    end
  end
  ...
  describe 'test attribute "fixed_term_id"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
