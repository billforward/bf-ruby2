...
# Unit tests for Bfwd::FixedTermExpiryAmendment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FixedTermExpiryAmendment' do
  before do
    # run before each test
    @instance = Bfwd::FixedTermExpiryAmendment.new
  end
  ...
  describe 'test an instance of FixedTermExpiryAmendment' do
    it 'should create an instance of FixedTermExpiryAmendment' do
      expect(@instance).to be_instance_of(Bfwd::FixedTermExpiryAmendment)
    end
  end
