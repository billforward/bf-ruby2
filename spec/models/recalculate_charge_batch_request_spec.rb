...
# Unit tests for BillForward::RecalculateChargeBatchRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RecalculateChargeBatchRequest' do
  before do
    # run before each test
    @instance = BillForward::RecalculateChargeBatchRequest.new
  end
  ...
  describe 'test an instance of RecalculateChargeBatchRequest' do
    it 'should create an instact of RecalculateChargeBatchRequest' do
      expect(@instance).to be_instance_of(BillForward::RecalculateChargeBatchRequest)
    end
  end
