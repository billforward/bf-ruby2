...
# Unit tests for BillForward::InvoicePayment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoicePayment' do
  before do
    # run before each test
    @instance = BillForward::InvoicePayment.new
  end
  ...
  describe 'test an instance of InvoicePayment' do
    it 'should create an instact of InvoicePayment' do
      expect(@instance).to be_instance_of(BillForward::InvoicePayment)
    end
  end
