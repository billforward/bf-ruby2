...
# Unit tests for BillForward::StripeAuthCaptureRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StripeAuthCaptureRequest' do
  before do
    # run before each test
    @instance = BillForward::StripeAuthCaptureRequest.new
  end
  ...
  describe 'test an instance of StripeAuthCaptureRequest' do
    it 'should create an instact of StripeAuthCaptureRequest' do
      expect(@instance).to be_instance_of(BillForward::StripeAuthCaptureRequest)
    end
  end
