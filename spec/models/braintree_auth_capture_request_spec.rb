...
# Unit tests for BillForward::BraintreeAuthCaptureRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BraintreeAuthCaptureRequest' do
  before do
    # run before each test
    @instance = BillForward::BraintreeAuthCaptureRequest.new
  end
  ...
  describe 'test an instance of BraintreeAuthCaptureRequest' do
    it 'should create an instact of BraintreeAuthCaptureRequest' do
      expect(@instance).to be_instance_of(BillForward::BraintreeAuthCaptureRequest)
    end
  end
