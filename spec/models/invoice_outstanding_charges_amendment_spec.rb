...
# Unit tests for BillForward::InvoiceOutstandingChargesAmendment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceOutstandingChargesAmendment' do
  before do
    # run before each test
    @instance = BillForward::InvoiceOutstandingChargesAmendment.new
  end
  ...
  describe 'test an instance of InvoiceOutstandingChargesAmendment' do
    it 'should create an instact of InvoiceOutstandingChargesAmendment' do
      expect(@instance).to be_instance_of(BillForward::InvoiceOutstandingChargesAmendment)
    end
  end
