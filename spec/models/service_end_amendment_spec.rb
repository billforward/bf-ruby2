...
# Unit tests for BillForward::ServiceEndAmendment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceEndAmendment' do
  before do
    # run before each test
    @instance = BillForward::ServiceEndAmendment.new
  end
  ...
  describe 'test an instance of ServiceEndAmendment' do
    it 'should create an instact of ServiceEndAmendment' do
      expect(@instance).to be_instance_of(BillForward::ServiceEndAmendment)
    end
  end
