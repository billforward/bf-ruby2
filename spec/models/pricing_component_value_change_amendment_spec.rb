...
# Unit tests for Bfwd::PricingComponentValueChangeAmendment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PricingComponentValueChangeAmendment' do
  before do
    # run before each test
    @instance = Bfwd::PricingComponentValueChangeAmendment.new
  end
  ...
  describe 'test an instance of PricingComponentValueChangeAmendment' do
    it 'should create an instance of PricingComponentValueChangeAmendment' do
      expect(@instance).to be_instance_of(Bfwd::PricingComponentValueChangeAmendment)
    end
  end
