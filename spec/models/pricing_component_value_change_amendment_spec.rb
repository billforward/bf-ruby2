...
# Unit tests for BillForward::PricingComponentValueChangeAmendment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PricingComponentValueChangeAmendment' do
  before do
    # run before each test
    @instance = BillForward::PricingComponentValueChangeAmendment.new
  end
  ...
  describe 'test an instance of PricingComponentValueChangeAmendment' do
    it 'should create an instact of PricingComponentValueChangeAmendment' do
      expect(@instance).to be_instance_of(BillForward::PricingComponentValueChangeAmendment)
    end
  end
  ...
  describe 'test attribute "component_changes"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
