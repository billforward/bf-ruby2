...
# Unit tests for Bfwd::UpdatePricingComponentValueResponsePagedMetadata
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdatePricingComponentValueResponsePagedMetadata' do
  before do
    # run before each test
    @instance = Bfwd::UpdatePricingComponentValueResponsePagedMetadata.new
  end
  ...
  describe 'test an instance of UpdatePricingComponentValueResponsePagedMetadata' do
    it 'should create an instance of UpdatePricingComponentValueResponsePagedMetadata' do
      expect(@instance).to be_instance_of(Bfwd::UpdatePricingComponentValueResponsePagedMetadata)
    end
  end
