...
# Unit tests for Bfwd::ResumeSubscriptionAmendment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResumeSubscriptionAmendment' do
  before do
    # run before each test
    @instance = Bfwd::ResumeSubscriptionAmendment.new
  end
  ...
  describe 'test an instance of ResumeSubscriptionAmendment' do
    it 'should create an instance of ResumeSubscriptionAmendment' do
      expect(@instance).to be_instance_of(Bfwd::ResumeSubscriptionAmendment)
    end
  end
