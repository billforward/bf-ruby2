...
# Unit tests for Bfwd::UpdatePricingComponentValueRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdatePricingComponentValueRequest' do
  before do
    # run before each test
    @instance = Bfwd::UpdatePricingComponentValueRequest.new
  end
  ...
  describe 'test an instance of UpdatePricingComponentValueRequest' do
    it 'should create an instance of UpdatePricingComponentValueRequest' do
      expect(@instance).to be_instance_of(Bfwd::UpdatePricingComponentValueRequest)
    end
  end
