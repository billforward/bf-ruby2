...
# Unit tests for BillForward::InvoiceNextExecutionAttemptAmendment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceNextExecutionAttemptAmendment' do
  before do
    # run before each test
    @instance = BillForward::InvoiceNextExecutionAttemptAmendment.new
  end
  ...
  describe 'test an instance of InvoiceNextExecutionAttemptAmendment' do
    it 'should create an instact of InvoiceNextExecutionAttemptAmendment' do
      expect(@instance).to be_instance_of(BillForward::InvoiceNextExecutionAttemptAmendment)
    end
  end
  ...
  describe 'test attribute "force_paid"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
