...
# Unit tests for Bfwd::InvoiceNextExecutionAttemptAmendment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceNextExecutionAttemptAmendment' do
  before do
    # run before each test
    @instance = Bfwd::InvoiceNextExecutionAttemptAmendment.new
  end
  ...
  describe 'test an instance of InvoiceNextExecutionAttemptAmendment' do
    it 'should create an instance of InvoiceNextExecutionAttemptAmendment' do
      expect(@instance).to be_instance_of(Bfwd::InvoiceNextExecutionAttemptAmendment)
    end
  end
