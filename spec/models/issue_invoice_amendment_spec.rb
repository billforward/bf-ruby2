...
# Unit tests for Bfwd::IssueInvoiceAmendment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IssueInvoiceAmendment' do
  before do
    # run before each test
    @instance = Bfwd::IssueInvoiceAmendment.new
  end
  ...
  describe 'test an instance of IssueInvoiceAmendment' do
    it 'should create an instance of IssueInvoiceAmendment' do
      expect(@instance).to be_instance_of(Bfwd::IssueInvoiceAmendment)
    end
  end
