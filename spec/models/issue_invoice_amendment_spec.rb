...
# Unit tests for BillForward::IssueInvoiceAmendment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IssueInvoiceAmendment' do
  before do
    # run before each test
    @instance = BillForward::IssueInvoiceAmendment.new
  end
  ...
  describe 'test an instance of IssueInvoiceAmendment' do
    it 'should create an instact of IssueInvoiceAmendment' do
      expect(@instance).to be_instance_of(BillForward::IssueInvoiceAmendment)
    end
  end
