...
# Unit tests for Bfwd::InvoiceRecalculationAmendment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceRecalculationAmendment' do
  before do
    # run before each test
    @instance = Bfwd::InvoiceRecalculationAmendment.new
  end
  ...
  describe 'test an instance of InvoiceRecalculationAmendment' do
    it 'should create an instance of InvoiceRecalculationAmendment' do
      expect(@instance).to be_instance_of(Bfwd::InvoiceRecalculationAmendment)
    end
  end
