...
# Unit tests for BillForward::InvoiceRecalculationAmendment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceRecalculationAmendment' do
  before do
    # run before each test
    @instance = BillForward::InvoiceRecalculationAmendment.new
  end
  ...
  describe 'test an instance of InvoiceRecalculationAmendment' do
    it 'should create an instact of InvoiceRecalculationAmendment' do
      expect(@instance).to be_instance_of(BillForward::InvoiceRecalculationAmendment)
    end
  end
  ...
  describe 'test attribute "new_invoice_state"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Paid", "Unpaid", "Pending", "Voided"])
       #validator.allowable_values.each do |value|
       #  expect { @instance.new_invoice_state = value }.not_to raise_error
       #end
    end
  end
