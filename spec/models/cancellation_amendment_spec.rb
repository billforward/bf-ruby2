...
# Unit tests for Bfwd::CancellationAmendment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CancellationAmendment' do
  before do
    # run before each test
    @instance = Bfwd::CancellationAmendment.new
  end
  ...
  describe 'test an instance of CancellationAmendment' do
    it 'should create an instance of CancellationAmendment' do
      expect(@instance).to be_instance_of(Bfwd::CancellationAmendment)
    end
  end
