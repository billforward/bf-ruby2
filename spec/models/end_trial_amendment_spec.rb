...
# Unit tests for Bfwd::EndTrialAmendment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EndTrialAmendment' do
  before do
    # run before each test
    @instance = Bfwd::EndTrialAmendment.new
  end
  ...
  describe 'test an instance of EndTrialAmendment' do
    it 'should create an instance of EndTrialAmendment' do
      expect(@instance).to be_instance_of(Bfwd::EndTrialAmendment)
    end
  end
