...
# Unit tests for BillForward::AuthCaptureRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AuthCaptureRequest' do
  before do
    # run before each test
    @instance = BillForward::AuthCaptureRequest.new
  end
  ...
  describe 'test an instance of AuthCaptureRequest' do
    it 'should create an instact of AuthCaptureRequest' do
      expect(@instance).to be_instance_of(BillForward::AuthCaptureRequest)
    end
  end
