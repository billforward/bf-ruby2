...
# Unit tests for BillForward::AmendmentDiscardAmendment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmendmentDiscardAmendment' do
  before do
    # run before each test
    @instance = BillForward::AmendmentDiscardAmendment.new
  end
  ...
  describe 'test an instance of AmendmentDiscardAmendment' do
    it 'should create an instact of AmendmentDiscardAmendment' do
      expect(@instance).to be_instance_of(BillForward::AmendmentDiscardAmendment)
    end
  end
