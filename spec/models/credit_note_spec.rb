...
# Unit tests for BillForward::CreditNote
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreditNote' do
  before do
    # run before each test
    @instance = BillForward::CreditNote.new
  end
  ...
  describe 'test an instance of CreditNote' do
    it 'should create an instact of CreditNote' do
      expect(@instance).to be_instance_of(BillForward::CreditNote)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["invoice", "manual"])
  ...
  describe 'test attribute "remaining_value"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
