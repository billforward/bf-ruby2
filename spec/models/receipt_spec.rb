...
# Unit tests for BillForward::Receipt
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Receipt' do
  before do
    # run before each test
    @instance = BillForward::Receipt.new
  end
  ...
  describe 'test an instance of Receipt' do
    it 'should create an instact of Receipt' do
      expect(@instance).to be_instance_of(BillForward::Receipt)
    end
  end
