...
# Unit tests for BillForward::CybersourcetokensApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CybersourcetokensApi' do
  before do
    # run before each test
    @instance = BillForward::CybersourcetokensApi.new
  end
  ...
  describe 'test an instance of CybersourcetokensApi' do
    it 'should create an instact of CybersourcetokensApi' do
      expect(@instance).to be_instance_of(BillForward::CybersourcetokensApi)
    end
  end
