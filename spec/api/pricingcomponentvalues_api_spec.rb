...
# Unit tests for Bfwd::PricingcomponentvaluesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PricingcomponentvaluesApi' do
  before do
    # run before each test
    @instance = Bfwd::PricingcomponentvaluesApi.new
  end
  ...
  describe 'test an instance of PricingcomponentvaluesApi' do
    it 'should create an instance of PricingcomponentvaluesApi' do
      expect(@instance).to be_instance_of(Bfwd::PricingcomponentvaluesApi)
    end
  end
