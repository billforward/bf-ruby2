...
# Unit tests for Bfwd::SynchAppConfigsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SynchAppConfigsApi' do
  before do
    # run before each test
    @instance = Bfwd::SynchAppConfigsApi.new
  end
  ...
  describe 'test an instance of SynchAppConfigsApi' do
    it 'should create an instance of SynchAppConfigsApi' do
      expect(@instance).to be_instance_of(Bfwd::SynchAppConfigsApi)
    end
  end
