...
# Unit tests for BillForward::CouponbookApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CouponbookApi' do
  before do
    # run before each test
    @instance = BillForward::CouponbookApi.new
  end
  ...
  describe 'test an instance of CouponbookApi' do
    it 'should create an instact of CouponbookApi' do
      expect(@instance).to be_instance_of(BillForward::CouponbookApi)
    end
  end
