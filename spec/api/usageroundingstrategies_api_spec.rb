...
# Unit tests for BillForward::UsageroundingstrategiesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UsageroundingstrategiesApi' do
  before do
    # run before each test
    @instance = BillForward::UsageroundingstrategiesApi.new
  end
  ...
  describe 'test an instance of UsageroundingstrategiesApi' do
    it 'should create an instact of UsageroundingstrategiesApi' do
      expect(@instance).to be_instance_of(BillForward::UsageroundingstrategiesApi)
    end
  end
