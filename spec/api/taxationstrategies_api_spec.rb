...
# Unit tests for BillForward::TaxationstrategiesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TaxationstrategiesApi' do
  before do
    # run before each test
    @instance = BillForward::TaxationstrategiesApi.new
  end
  ...
  describe 'test an instance of TaxationstrategiesApi' do
    it 'should create an instact of TaxationstrategiesApi' do
      expect(@instance).to be_instance_of(BillForward::TaxationstrategiesApi)
    end
  end
