...
# Unit tests for BillForward::CouponruleApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CouponruleApi' do
  before do
    # run before each test
    @instance = BillForward::CouponruleApi.new
  end
  ...
  describe 'test an instance of CouponruleApi' do
    it 'should create an instact of CouponruleApi' do
      expect(@instance).to be_instance_of(BillForward::CouponruleApi)
    end
  end
