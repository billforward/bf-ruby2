...
# Unit tests for BillForward::PricingcomponentsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PricingcomponentsApi' do
  before do
    # run before each test
    @instance = BillForward::PricingcomponentsApi.new
  end
  ...
  describe 'test an instance of PricingcomponentsApi' do
    it 'should create an instact of PricingcomponentsApi' do
      expect(@instance).to be_instance_of(BillForward::PricingcomponentsApi)
    end
  end
