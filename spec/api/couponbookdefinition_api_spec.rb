...
# Unit tests for Bfwd::CouponbookdefinitionApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CouponbookdefinitionApi' do
  before do
    # run before each test
    @instance = Bfwd::CouponbookdefinitionApi.new
  end
  ...
  describe 'test an instance of CouponbookdefinitionApi' do
    it 'should create an instance of CouponbookdefinitionApi' do
      expect(@instance).to be_instance_of(Bfwd::CouponbookdefinitionApi)
    end
  end
