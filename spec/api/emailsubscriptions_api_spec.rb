...
# Unit tests for BillForward::EmailsubscriptionsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EmailsubscriptionsApi' do
  before do
    # run before each test
    @instance = BillForward::EmailsubscriptionsApi.new
  end
  ...
  describe 'test an instance of EmailsubscriptionsApi' do
    it 'should create an instact of EmailsubscriptionsApi' do
      expect(@instance).to be_instance_of(BillForward::EmailsubscriptionsApi)
    end
  end
