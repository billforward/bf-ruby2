...
# Unit tests for BillForward::VaultedgatewaysApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VaultedgatewaysApi' do
  before do
    # run before each test
    @instance = BillForward::VaultedgatewaysApi.new
  end
  ...
  describe 'test an instance of VaultedgatewaysApi' do
    it 'should create an instact of VaultedgatewaysApi' do
      expect(@instance).to be_instance_of(BillForward::VaultedgatewaysApi)
    end
  end
