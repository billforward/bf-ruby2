...
# Unit tests for Bfwd::UsagesessionsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UsagesessionsApi' do
  before do
    # run before each test
    @instance = Bfwd::UsagesessionsApi.new
  end
  ...
  describe 'test an instance of UsagesessionsApi' do
    it 'should create an instance of UsagesessionsApi' do
      expect(@instance).to be_instance_of(Bfwd::UsagesessionsApi)
    end
  end
