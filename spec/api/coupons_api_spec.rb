...
# Unit tests for BillForward::CouponsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CouponsApi' do
  before do
    # run before each test
    @instance = BillForward::CouponsApi.new
  end
  ...
  describe 'test an instance of CouponsApi' do
    it 'should create an instact of CouponsApi' do
      expect(@instance).to be_instance_of(BillForward::CouponsApi)
    end
  end
