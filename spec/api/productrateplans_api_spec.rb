...
# Unit tests for BillForward::ProductrateplansApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProductrateplansApi' do
  before do
    # run before each test
    @instance = BillForward::ProductrateplansApi.new
  end
  ...
  describe 'test an instance of ProductrateplansApi' do
    it 'should create an instact of ProductrateplansApi' do
      expect(@instance).to be_instance_of(BillForward::ProductrateplansApi)
    end
  end
