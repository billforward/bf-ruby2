...
gem install ./bf_ruby2-1.2016.229.gem
```

Developers should instead run `gem install --dev ./bf_ruby2-1.2016.229.gem`, to install development dependencies.
...
Once [installed](#installed), you can try out the following example:
