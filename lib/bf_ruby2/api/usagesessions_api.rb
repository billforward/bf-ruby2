...
module Bfwd
  class UsagesessionsApi
    ...
    def get_active_sessions_for_subscription_with_http_info(subscription_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'subscription_id' when calling UsagesessionsApi.get_active_sessions_for_subscription" if subscription_id.nil?
      if opts[:'order'] && !['ASC', 'DESC'].include?(opts[:'order'])
        fail ArgumentError, 'invalid value for "order", must be one of ASC, DESC'
      end
      # resource path
      local_var_path = "/usage-sessions/{subscription-id}/active".sub('{format}','json').sub('{' + 'subscription-id' + '}', subscription_id.to_s)
    ...
    def get_usage_list_for_usage_session_with_http_info(subscription_id, opts = {})
      ...
      # verify the required parameter 'subscription_id' is set
      fail ArgumentError, "Missing the required parameter 'subscription_id' when calling UsagesessionsApi.get_usage_list_for_usage_session" if subscription_id.nil?
      if opts[:'order'] && !['ASC', 'DESC'].include?(opts[:'order'])
        fail ArgumentError, 'invalid value for "order", must be one of ASC, DESC'
      end
      # resource path
      local_var_path = "/usage-sessions/{subscription-id}".sub('{format}','json').sub('{' + 'subscription-id' + '}', subscription_id.to_s)
    ...
    def start_usage_session_with_http_info(usage_sessions, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'usage_sessions' when calling UsagesessionsApi.start_usage_session" if usage_sessions.nil?
      # resource path
      local_var_path = "/usage-sessions/start".sub('{format}','json')
    ...
    def stop_usage_session_with_http_info(usage_sessions, opts = {})
      ...
      # verify the required parameter 'usage_sessions' is set
      fail ArgumentError, "Missing the required parameter 'usage_sessions' when calling UsagesessionsApi.stop_usage_session" if usage_sessions.nil?
      # resource path
      local_var_path = "/usage-sessions/stop".sub('{format}','json')
