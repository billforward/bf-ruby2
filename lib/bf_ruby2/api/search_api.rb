...
module BillForward
  class SearchApi
    ...
    def perform_search(query_string, opts = {})
      data, _status_code, _headers = perform_search_with_http_info(query_string, opts)
      return data
    end
    ...
    # @return [Array<(SearchResultPagedMetadata, Fixnum, Hash)>] SearchResultPagedMetadata data, response status code and response headers
