...
module BillForward
  class FixedtermdefinitionsApi
    ...
    def create_fixed_term_definition_with_http_info(fixed_term_definiton, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'fixed_term_definiton' when calling FixedtermdefinitionsApi.create_fixed_term_definition" if fixed_term_definiton.nil?
      # resource path
      local_var_path = "/fixed-term-definitions".sub('{format}','json')
    ...
    def update_fixed_term_definition_with_http_info(fixed_term_definiton, opts = {})
      ...
      # verify the required parameter 'fixed_term_definiton' is set
      fail ArgumentError, "Missing the required parameter 'fixed_term_definiton' when calling FixedtermdefinitionsApi.update_fixed_term_definition" if fixed_term_definiton.nil?
      # resource path
      local_var_path = "/fixed-term-definitions".sub('{format}','json')
