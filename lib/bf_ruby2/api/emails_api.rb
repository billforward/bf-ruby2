...
module BillForward
  class EmailsApi
    ...
    def get_email_by_id_with_http_info(email_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'email_id' when calling EmailsApi.get_email_by_id" if email_id.nil?
      # resource path
      local_var_path = "/emails/{email-ID}".sub('{format}','json').sub('{' + 'email-ID' + '}', email_id.to_s)
    ...
    def get_email_html_by_id_with_http_info(email_id, opts = {})
      ...
      # verify the required parameter 'email_id' is set
      fail ArgumentError, "Missing the required parameter 'email_id' when calling EmailsApi.get_email_html_by_id" if email_id.nil?
      # resource path
      local_var_path = "/emails/{email-ID}.html".sub('{format}','json').sub('{' + 'email-ID' + '}', email_id.to_s)
    ...
    def get_email_text_by_id_with_http_info(email_id, opts = {})
      ...
      # verify the required parameter 'email_id' is set
      fail ArgumentError, "Missing the required parameter 'email_id' when calling EmailsApi.get_email_text_by_id" if email_id.nil?
      # resource path
      local_var_path = "/emails/{email-ID}.txt".sub('{format}','json').sub('{' + 'email-ID' + '}', email_id.to_s)
