...
module Bfwd
  ...
  class CreateAccountProfileRequest
    ...
    def self.swagger_types
      {
        ...
        :'company_name' => :'String',
        :'logo_url' => :'String',
        :'addresses' => :'Array<CreateProfileAddressRequest>',
        :'mobile' => :'String',
        :'landline' => :'String',
        :'fax' => :'String',
        :'dob' => :'DateTime',
    ...
    def hash
      [account_id, email, first_name, last_name, company_name, logo_url, addresses, mobile, landline, fax, dob, vat_number, additional_information].hash
    end
