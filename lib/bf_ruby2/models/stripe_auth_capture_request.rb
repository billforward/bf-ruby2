...
module Bfwd
  ...
  class StripeAuthCaptureRequest
    attr_accessor :type
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'stripeToken')
        self.stripe_token = attributes[:'stripeToken']
      end
    ...
    def list_invalid_properties
      ...
      if @stripe_token.nil?
        invalid_properties.push("invalid value for 'stripe_token', stripe_token cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @stripe_token.nil?
      return true
    end
    ...
    def hash
      [type, account_id, gateway, company_name, email, first_name, last_name, mobile, default_payment_method, organization_id, stripe_token, card_id, customer_id].hash
    end
