...
module Bfwd
  ...
  class BFError
    ...
    attr_accessor :error_parameters
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'errorParameters')
        if (value = attributes[:'errorParameters']).is_a?(Array)
          self.error_parameters = value
        end
      end
    ...
    def error_type=(error_type)
      validator = EnumAttributeValidator.new('String', ["BFError", "ServerError", "ValidationError", "UnserializationException", "Oauth", "PermissionsError", "PreconditionFailed", "NotImplemented", "InvocationError", "NoSuchEntity", "InconsistentState", "StripeOperationFailure", "BraintreeOperationFailure", "BraintreeValidationError", "SagePayOperationFailure", "TokenizationAuthCaptureFailure", "TokenizationPreAuthFailure", "CouponException", "CouponUniqueCodesRequestException", "CouponUniqueCodesResponseException", "RemoveCouponException", "AddCouponCodeToSubscriptionRequestException", "GatewayAuthenticationError", "GatewayAuthorizationError", "GatewayResourceNotFoundError", "GatewayProtocolVersionError", "GatewayInternalError", "GatewayDownTemporarilyError", "GatewayUnexpectedError", "GatewayUnhandledError", "GatewaySDKUnhandledError"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          error_parameters == o.error_parameters
    end
    ...
    def hash
      [error_type, error_message, error_code, error_parameters].hash
    end
