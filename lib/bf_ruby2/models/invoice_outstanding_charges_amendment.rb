...
module BillForward
  ...
  class InvoiceOutstandingChargesAmendment
    ...
    # { \"description\" : \"ID of the Invoice with which the amendment is associated.\", \"verbs\":[\"POST\",\"PUT\",\"GET\"] }
    ...
    def hash
      [created, changed_by, updated, type, id, organization_id, subscription_id, amendment_type, actioning_time, actioned_time, state, deleted, invoice_id].hash
    end
