...
module Bfwd
  ...
  class TimeRequest
    ...
    attr_accessor :skip_intermediate_periods
    ...
    attr_accessor :handle_amendments
    ...
    attr_accessor :freeze_on_completion
    ...
    attr_accessor :advance_inclusively
    ...
    # @param [Object] execution_strategy Object to be assigned
    def execution_strategy=(execution_strategy)
      validator = EnumAttributeValidator.new('String', ["SingleAttempt", "FollowDunning", "None"])
      unless validator.valid?(execution_strategy)
        fail ArgumentError, "invalid value for 'execution_strategy', must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [created, periods, to, dry_run, skip_intermediate_periods, handle_amendments, execution_strategy, freeze_on_completion, advance_inclusively].hash
    end
