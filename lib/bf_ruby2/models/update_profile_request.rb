...
module BillForward
  ...
  class UpdateProfileRequest
    ...
    def hash
      [id, account_id, organization_id, email, first_name, last_name, company_name, logo_url, addresses, mobile, landline, fax, dob, vat_number, additional_information].hash
    end
