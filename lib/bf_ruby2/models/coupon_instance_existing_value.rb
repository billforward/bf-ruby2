...
module Bfwd
  ...
  class CouponInstanceExistingValue
    ...
    def list_invalid_properties
      ...
      if @logical_component_id.nil?
        invalid_properties.push("invalid value for 'logical_component_id', logical_component_id cannot be nil.")
      end

      if @existing_value.nil?
        invalid_properties.push("invalid value for 'existing_value', existing_value cannot be nil.")
      end
