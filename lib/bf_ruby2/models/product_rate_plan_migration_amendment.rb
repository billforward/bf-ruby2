...
module Bfwd
  ...
  class ProductRatePlanMigrationAmendment
    ...
    attr_accessor :next_subscription_id
    ...
    def self.swagger_types
      {
        ...
        :'mappings' => :'Array<PricingComponentValueMigrationAmendmentMapping>',
        :'previous_subscription_id' => :'String',
        :'next_subscription_id' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'nextSubscriptionID')
        self.next_subscription_id = attributes[:'nextSubscriptionID']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          next_subscription_id == o.next_subscription_id &&
    ...
    def hash
      [created, changed_by, updated, type, id, organization_id, subscription_id, amendment_type, actioning_time, actioned_time, state, deleted, product_rate_plan_id, invoicing_type, mappings, previous_subscription_id, next_subscription_id, next_subscription_name, next_subscription_description, pricing_behaviour].hash
    end
