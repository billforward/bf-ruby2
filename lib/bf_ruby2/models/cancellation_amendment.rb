...
module Bfwd
  ...
  class CancellationAmendment
    ...
    def list_invalid_properties
      ...
      if @service_end.nil?
        invalid_properties.push("invalid value for 'service_end', service_end cannot be nil.")
      end

      if @cancellation_credit.nil?
        invalid_properties.push("invalid value for 'cancellation_credit', cancellation_credit cannot be nil.")
      end
