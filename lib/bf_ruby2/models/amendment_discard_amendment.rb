...
module Bfwd
  ...
  class AmendmentDiscardAmendment
    ...
    # { \"description\" : \"ID of the amendment to discard.\", \"verbs\":[\"POST\",\"PUT\",\"GET\"] }
    attr_accessor :amendment_to_discard_id
    ...
    def self.swagger_types
      {
        ...
        :'state' => :'String',
        :'deleted' => :'BOOLEAN',
        :'amendment_to_discard_id' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'amendmentToDiscardID')
        self.amendment_to_discard_id = attributes[:'amendmentToDiscardID']
      end
    ...
    def list_invalid_properties
      ...
      if @amendment_to_discard_id.nil?
        invalid_properties.push("invalid value for 'amendment_to_discard_id', amendment_to_discard_id cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @amendment_to_discard_id.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          state == o.state &&
          deleted == o.deleted &&
          amendment_to_discard_id == o.amendment_to_discard_id
    end
    ...
    def hash
      [created, changed_by, updated, type, id, organization_id, subscription_id, amendment_type, actioning_time, actioned_time, state, deleted, amendment_to_discard_id].hash
    end
