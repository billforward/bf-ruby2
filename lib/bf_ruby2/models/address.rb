...
module Bfwd
  ...
  class Address
    ...
    def hash
      [created, changed_by, updated, id, profile_id, organization_id, address_line1, address_line2, address_line3, city, province, country, postcode, landline, primary_address, deleted].hash
    end
