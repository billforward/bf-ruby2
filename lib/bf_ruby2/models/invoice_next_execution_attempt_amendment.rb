...
module Bfwd
  ...
  class InvoiceNextExecutionAttemptAmendment
    ...
    # { \"description\" : \"ID of the Invoice to which the amendment pertains.\", \"verbs\":[\"POST\",\"PUT\",\"GET\"] }
    attr_accessor :invoice_id

    # { \"description\" : \"Create an offline payment and force the invoice into the paid state.\", \"verbs\":[\"POST\",\"PUT\",\"GET\"] }
    attr_accessor :force_paid
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'forcePaid')
        self.force_paid = attributes[:'forcePaid']
      else
    ...
    def list_invalid_properties
      ...
      if @force_paid.nil?
        invalid_properties.push("invalid value for 'force_paid', force_paid cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @force_paid.nil?
      return true
    end
    ...
    def hash
      [created, changed_by, updated, type, id, organization_id, subscription_id, amendment_type, actioning_time, actioned_time, state, deleted, invoice_id, force_paid].hash
    end
