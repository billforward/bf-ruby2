...
module Bfwd
  ...
  class FixedTermExpiryAmendment
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'fixedTermID')
        self.fixed_term_id = attributes[:'fixedTermID']
      end
    ...
    def list_invalid_properties
      ...
      if @fixed_term_id.nil?
        invalid_properties.push("invalid value for 'fixed_term_id', fixed_term_id cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @fixed_term_id.nil?
      return true
    end
    ...
    def hash
      [created, changed_by, updated, type, id, organization_id, subscription_id, amendment_type, actioning_time, actioned_time, state, deleted, fixed_term_id].hash
    end
